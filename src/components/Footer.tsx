...
const Footer = () => {
    return (
        ...
        <div className="flex flex-col">
          <h6 className="text-xl font-semibold mb-5">Company</h6> 
        ...
        <div className="flex flex-col items-center  ">
          <h6 className="text-xl font-semibold mb-5">Social</h6> 
          <div className="flex   md:gap-6 gap-2">
          <FaTwitter className="hover:scale-125 md:w-9 md:h-5 transition-all duration-200 ease-out" />
          <RiInstagramFill className="hover:scale-125 md:w-9 md:h-5 transition-all duration-200 ease-out " />
